...
#'
#' @param attachment un rid de pièce jointe, un objet `dido_datafile()` ou `dido_job()`
#' @param title le titre d'une pièce jointe
...
#' }
get_attachent <- function(datafile = NULL, title = NULL, dataset = NULL) {
